...
export default function Adminasig() {
  ...
  return (
    <>
    <div> <h1 className="title w-11/12 mx-auto my-10">Admin asignado</h1> </div>
      <div className="flex flex-col lg:flex-row">
        <div className="basis-1/2">
          <h1 className="title my-10">Members sin asignacion</h1>
        ...
        <div className="basis-1/2">
          <h1 className="title my-10">Members asignados</h1>
          {asignados.length === 0 ? (
            "No hay asignados..."
          ) : (
            <div className="flex flex-col justify-center  mt-5 mx-auto w-11/12 sm:w-10/12 ">
