...
function getSearchEmpleado(_x7, _x8) {
  return _getSearchEmpleado.apply(this, arguments);
}

function _getSearchEmpleado() {
  _getSearchEmpleado = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee4(req, res) {
    var _req$params, page, filterName, data_empleados;

    return _regenerator["default"].wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _req$params = req.params, page = _req$params.page, filterName = _req$params.filterName;
            _context4.prev = 1;
            _context4.next = 4;
            return _empleado.Empleado.getSearchDataEmpleado(page, filterName);
...
function postEmpleado(_x9, _x10) {
  return _postEmpleado.apply(this, arguments);
}

function _postEmpleado() {
  _postEmpleado = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5(req, res) {
    ...
    return _regenerator["default"].wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 8:
            data_post_empleado = _context5.sent;
            console.log({
...
function updateChapterMember(_x11, _x12) {
  return _updateChapterMember.apply(this, arguments);
}

function _updateChapterMember() {
  _updateChapterMember = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee6(req, res) {
...
function updateCMasCL(_x13, _x14) {
  return _updateCMasCL.apply(this, arguments);
}

function _updateCMasCL() {
  _updateCMasCL = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee7(req, res) {
